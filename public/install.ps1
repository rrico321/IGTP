...
Invoke-WebRequest -Uri "https://raw.githubusercontent.com/rrico321/IGTP/main/igtp-daemon/index.ts" -OutFile "$IGTP_DIR\daemon\index.ts"
Invoke-WebRequest -Uri "https://raw.githubusercontent.com/rrico321/IGTP/main/igtp-daemon/package.json" -OutFile "$IGTP_DIR\daemon\package.json"
...
"@ | Out-File -FilePath "$IGTP_DIR\.env" -Encoding ascii
...
# ─── Auto-start ──────────────────────────────────────────────────────────
Write-Host ""
Write-Host "Step 3: Auto-start" -ForegroundColor White
Write-Host ""
